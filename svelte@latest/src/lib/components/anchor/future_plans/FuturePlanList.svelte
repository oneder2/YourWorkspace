  ...
  <div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
      <button
        ...
        class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 transition ease-in-out duration-150"
    ...
    {#if $isLoading && $futurePlans.length === 0}
      <div class="text-center py-10">
        <div role="status" class="flex justify-center items-center">
            <svg aria-hidden="true" class="w-10 h-10 text-green-200 animate-spin dark:text-green-700 fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p class="mt-2 text-green-600 dark:text-green-400">Loading future plans...</p>
      </div>
    {:else if $error}
      <div class="p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800 text-center" role="alert">
        ...
        <button
          ...
          class="ml-4 px-3 py-1.5 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"
        >
          Retry
        </button>
      </div>
    {:else if $futurePlans.length === 0}
      <div class="text-center py-10">
        <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
          <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
        <h3 class="mt-2 text-lg font-medium text-green-900 dark:text-green-100">No future plans yet</h3>
        <p class="mt-1 text-sm text-green-600 dark:text-green-400">Start planning your future!</p>
      </div>
    {:else}
      <div class="space-y-4">
