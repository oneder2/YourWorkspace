  ...
  <div class="container mx-auto px-4 py-8">
    ...
    {#if $isLoading && $achievements.length === 0}
      <div class="text-center py-10">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">正在加载成就...</p>
      </div>
    {:else if $error}
    ...
    {:else if $achievements.length === 0}
      <div class="text-center py-10">
        ...
        <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">暂无成就</h3>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">开始添加您的第一个成就吧！</p>
      </div>
    {:else}
